	...
	<div id="skystats-google-adwords-data-container" class="skystats-service-detail-container">
			...
			<h3 class="skystats-detail-header"><?php _e( 'Google Adwords', SKYSTATS_TEXT_DOMAIN ); ?>
				<div class="skystats-detail-icons">
					...
					<div id="skystats-google-adwords-grid-icon-content" class="skystats-grid-content">
						...
						<p>
							<label>
								<input type="checkbox" class="skystats-show-data-point" value="skystats-google-adwords-bounce-rate-data-point" checked>
								<?php _e( 'Bounce Rate', SKYSTATS_TEXT_DOMAIN ); ?>
							</label>
						</p>
					</div> <!-- #skystats-google-adwords-grid-icon-content -->
		...
		<div id="skystats-google-adwords-settings-content" class="skystats-settings-tab-settings-content">
			...
			<div id="skystats-google-adwords-account-selection-section" class="skystats-google-adwords-settings-tab-section skystats-settings-tab-section">
				...
				<select id="skystats-google-adwords-account-selection" class="skystats-card-settings-profiles" data-placeholder="<?php _e( 'Select an Account', SKYSTATS_TEXT_DOMAIN ); ?>"></select>
			</div>
			...
			<div id="skystats-google-adwords-campaign-selection-section" class="skystats-google-adwords-settings-tab-section skystats-settings-tab-section">
				...
				<p id="skystats-google-adwords-select-campaign-description"><?php _e( 'Select a campaign from the list below that you would like to see data for.', SKYSTATS_TEXT_DOMAIN ); ?></p>
			...
			<div id="skystats-google-adwords-settings-authorize-section" class="skystats-google-adwords-settings-tab-section skystats-settings-tab-section">
				<div class="skystats-card-settings-authorize-container">
					...
					<p><?php _e( 'Click the button below to login to Google Adwords and authorize the application.', SKYSTATS_TEXT_DOMAIN ); ?></p>
		...
		<div id="skystats-google-adwords-data-tab-content">
			...
			<div id="skystats-google-adwords-data-points-container" class="skystats-data-points-container">
				...
				<div id="skystats-google-adwords-avg-cost-per-conversion-data-point" class="skystats-service-detail-data-point-column skystats-data-point-column">
					<div class="skystats-service-detail-data-point-column-header">
						...
						<span class="skystats-dashboard-data-point-heading-info skystats-tooltip" data-tooltip="<?php _e( 'Average Cost Per Conversion during this period (total cost ÷ total conversions).', SKYSTATS_TEXT_DOMAIN ); ?>"></span>
					</div>
					<div class="skystats-service-detail-data-point-column-content">
			...
			</div> <!-- #skystats-google-adwords-data-points-container -->
			...
			<div class="skystats-service-detail-data-tables-container">
				...
				<div class="skystats-detail-data-table-row">
					...
					<div id="skystats-detail-google-adwords-campaign-level-ad-groups-data-table-column" class="skystats-service-detail-data-table-column">
						<div id="skystats-detail-google-adwords-campaign-level-ad-groups-data-table-column-content" class="skystats-data-table-column-content skystats-service-detail-data-table-column-content">
							<h2>
								<?php _e( 'Ad Groups', SKYSTATS_TEXT_DOMAIN ); ?>
								<span class="skystats-data-point-heading-info skystats-data-table-heading-info skystats-tooltip" title="<?php _e( 'The Bounce Rate over the current period.', SKYSTATS_TEXT_DOMAIN ); ?>"></span>
							</h2>
							<div id="skystats-google-adwords-campaign-level-ad-groups-data-error-container" class="skystats-top-data-error-container">
								<p><?php _e( 'No data available for this period.', SKYSTATS_TEXT_DOMAIN ); ?></p>
							</div>
							<table id="skystats-google-adwords-campaign-level-ad-groups-table" class="skystats-service-detail-data-table wp-list-table widefat">
								<thead>
								<tr>
									<th><?php _e( 'Ad Group Name', SKYSTATS_TEXT_DOMAIN ); ?></th>
									<th><?php _e( 'Clicks', SKYSTATS_TEXT_DOMAIN ); ?></th>
									<th><?php _e( 'Impressions', SKYSTATS_TEXT_DOMAIN ); ?></th>
									<th><?php _e( 'CTR', SKYSTATS_TEXT_DOMAIN ); ?></th>
									<th><?php _e( 'Avg. CPC', SKYSTATS_TEXT_DOMAIN ); ?></th>
					...
					<div id="skystats-detail-google-adwords-campaign-level-top-keyword-performance-data-table-column" class="skystats-service-detail-data-table-column">
						<div id="skystats-detail-google-adwords-campaign-level-top-keyword-performance-data-table-column-content" class="skystats-data-table-column-content skystats-service-detail-data-table-column-content">
							<h2>
								<?php _e( 'Top Keyword Performance', SKYSTATS_TEXT_DOMAIN ); ?>
								<span class="skystats-data-point-heading-info skystats-data-table-heading-info skystats-tooltip" title="<?php _e( 'The Bounce Rate over the current period.', SKYSTATS_TEXT_DOMAIN ); ?>"></span>
							</h2>
							<div id="skystats-google-adwords-campaign-level-top-keyword-performance-data-error-container" class="skystats-top-data-error-container">
								<p><?php _e( 'No data available for this period.', SKYSTATS_TEXT_DOMAIN ); ?></p>
							</div>
							<table id="skystats-google-adwords-campaign-level-top-keyword-performance-table" class="skystats-service-detail-data-table wp-list-table widefat">
								<thead>
								<tr>
									<th><?php _e( 'Keyword', SKYSTATS_TEXT_DOMAIN ); ?></th>
									<th><?php _e( 'Ad Group Name', SKYSTATS_TEXT_DOMAIN ); ?></th>
		...
		</div> <!-- #skystats-google-adwords-data-tab-content -->
	</div> <!-- #skystats-google-adwords-data-container -->
</div> <!-- .wrap -->