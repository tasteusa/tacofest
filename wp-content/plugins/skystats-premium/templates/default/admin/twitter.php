...
<div class="wrap">
	...
	<div id="skystats-twitter-data-container" class="skystats-service-detail-container">
		...
		<div id="skystats-twitter-historical-data-notice-container" class="skystats-error-container">
			<p id="skystats-twitter-historical-data-notice">
				<?php _e( 'Full historical data not available.', SKYSTATS_TEXT_DOMAIN ); ?>
