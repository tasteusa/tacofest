...
<div id="facebook_2" class="skystats-card-container">
	<div class="skystats-card">
		<div class="skystats-card-header">
			...
			<span id="skystats-facebook-settings-icon" class="skystats-card-settings skystats-setting-tool-tip skystats-tooltip skystats-disabled" data-tooltip="<?php _e( 'Configure Settings for Facebook', SKYSTATS_TEXT_DOMAIN ); ?>"></span>
			<span id="skystats-facebook-grid-icon" class="skystats-card-eye skystats-select-tool-tip skystats-tooltip skystats-disabled" data-tooltip="<?php _e( 'Show/Hide Facebook Data Points', SKYSTATS_TEXT_DOMAIN ); ?>"></span>
		...
		<div id="skystats-facebook-card-content" class="skystats-card-content">
			...
			<div id="skystats-facebook-range-error-container" class="skystats-error-container">
				<p id="skystats-facebook-range-error">
					<?php _e( 'Facebook only returns results within a 91 day period.', SKYSTATS_TEXT_DOMAIN ); ?>
					<a class="skystats-read-more" data-tooltip=""><?php _e( 'Read more.', SKYSTATS_TEXT_DOMAIN ); ?></a>
				</p>
			</div>
			...
			<div id="skystats-facebook-settings-content" class="skystats-settings-tab-settings-content">
				...
				<div id="skystats-facebook-settings-page-selection-section" class="skystats-facebook-settings-tab-section skystats-settings-tab-section">
					...
					<select id="skystats-facebook-page-list" class="skystats-card-settings-profiles"></select>
			...
			<div id="skystats-facebook-data-tab-content">
				...
				<div id="skystats-facebook-chart-container" class="skystats-mashboard-chart-container skystats-chart-container">
					<div id="skystats-facebook-chart" class="skystats-mashboard-chart"></div>
				</div>
