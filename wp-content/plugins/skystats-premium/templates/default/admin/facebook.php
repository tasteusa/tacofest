...
<div class="wrap">
	...
	<div id="skystats-date-range-container">
		...
		<input class="skystats-date" type="text" id="end_date" name="end_sate" required="required" value="">
		...
		<div class="skystats-detail-top-container">
			<h3 class="skystats-detail-header"><?php _e( 'Facebook', SKYSTATS_TEXT_DOMAIN ); ?>
				<div class="skystats-detail-icons">
					<span id="skystats-facebook-settings-icon" class="skystats-setting-tool-tip skystats-tooltip skystats-settings-icon skystats-disabled" data-tooltip="<?php _e( 'Configure Settings for Facebook', SKYSTATS_TEXT_DOMAIN ); ?>"></span>
					<span id="skystats-facebook-grid-icon" class="skystats-grid-icon skystats-select-tool-tip skystats-tooltip skystats-disabled" data-tooltip="<?php _e( 'Show/Hide Facebook Data Points', SKYSTATS_TEXT_DOMAIN ); ?>"></span>
